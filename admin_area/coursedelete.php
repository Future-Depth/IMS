...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		...
		<hr>
		<div class="col-12">
			<p class="lead"><font size="6"  color="black"><b>Delete an Existing Course:</b></font></p>
            <!--<p class="lead">1. View the complete student list.</p>
            <p class="lead">2. Modify the student details.</p>-->
		</div>
	</div>
</div>
<center><font size="5"  color="black">Choose the Course and Delete it</font></center>
<section>
<table border='2' align="center"><form method="post" action="course_delete.php">
	<tr><td>COURSE ID:</td><td><select name="cid" required="" autocomplete="off">
                          ...
                          <tr><td></td><td><button class="btn btn-primary btn-lg">Delete</button></td></tr>
                                        </form></table>
                                        </section><br><br>
<?php
if($_GET['ms']=='done'){
?><center>
<p><h3>Deleted Succesfully</h3></p>
<?php
}
else if($_GET['ms']=='not_done')
{
    ?><center>
<p><h3>Deletion Unsuccessful</h3></p>
<?php
}
else if($_GET['ms']=='not_present')
{
    ?><center>
<p><h3>Course ID is Not Present</h3></p>
<?php
}
?>
