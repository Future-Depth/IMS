...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		...
		<hr>
		<div class="col-12">
			<p class="lead"><font size="6"  color="black"><b>Assign Teacher for a Course:</b></font></p>
            <!--<p class="lead">1. View the complete student list.</p>
            <p class="lead">2. Modify the student details.</p>-->
		</div>
	</div>
</div>
<center><font size="5"  color="black">Fill the details and assign the teacher for the course</font></center>
<section>
<table border='2' align="center"><form method="post" action="course_teacher.php">
	<tr><td>COURSE ID:</td><td><select name="cid" required="" autocomplete="off">
                          <option value="">--Select--</option>
            
                               <?php
                               $s=mysqli_query($con,"select * from course where status='Active'");
                      ...
                      <tr><td>TEACHER ID:</td><td><input type="text" name='tid' required="" autocomplete="off"></td></tr>
                          <tr><td></td><td><button class="btn btn-primary btn-lg">Enroll Teacher</button></td></tr>
                                        </form></table>
                                        </section><br><br>
<?php
if($_GET['ms']=='done'){
?><center>
<p><h3>Assigned Succesfully</h3></p>
<?php
}
else if($_GET['ms']=='not_done')
{
    ?><center>
<p><h3>Couldnot Assigned due to Error</h3></p>
<?php
}
else if($_GET['ms']=='not_present')
{
    ?><center>
<p><h3>Teacher ID is Not Present</h3></p>
<?php
}
?>
