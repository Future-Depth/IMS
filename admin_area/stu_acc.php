...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		<div class="col-12">
			<h1 class="display-4">The Accounts Management System</h1>
		</div>
		<hr>
		<div class="col-12">
			<p class="lead"><font size="4"  color="black"><b>Student Transaction Details:</b></font></p>
...
<table border=2 align="center">
                                        <tr><th>STUDENT ID</th>
                                            ...
                                            <?php $s=mysqli_query($con,"SELECT a.stu_id,s.name,a.cou_id,c.c_name,a.amount,a.trans_id,a.trans_date FROM account as a inner join student as s on a.stu_id=s.stu_id inner join course as c on a.cou_id=c.c_id where a.type='Student Payment' ");
                                        while($r=mysqli_fetch_array($s))
                                        {
                                            ?>
                                            <tr><td><?php echo($r['stu_id']);?></td>
                                                <td><?php echo($r['name']);?></td>
                                                <td><?php echo($r['cou_id']);?></td>
