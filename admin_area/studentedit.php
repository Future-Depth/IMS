...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		<div class="col-12">
			<h1 class="display-4">The Student Management System</h1>
		</div>
		<hr>
		<div class="col-12">
			<p class="lead"><font size="6"  color="black"><b>Modify Student Details:</b></font></p>
            <!--<p class="lead">1. View the complete student list.</p>
            <p class="lead">2. Modify the student details.</p>-->
		</div>
	</div>
</div>
<center><font size="5"  color="black">Search a Student Details by their Student ID</font></center>
<section>
<table border='2' align="center"><form method="post" action="">
                               <tr><td>STUDENT ID : </td><td><input type="text" name="sid" required="" autocomplete="off"></td></tr>
                               <tr><td></td><td><button class="btn btn-primary btn-lg">Search</button></td></tr>
                                        </form></table>
                                        </section><br><br>
<?php
$sid=$_POST['sid'];
$s=mysqli_query($con,"select * from student where stu_id='$sid'");
...
<p><h2>SEARCH FOUND</h2></p></center>
          ...
          <img src="../<?php echo($r['photo']) ?>" class="img-fluid" height="150px" width="200px"></center>
			<p><table align="center"><form method="post" action="stu_edit.php">
            <tr><td>USER ID:</td><td><input type="text" name="uid" value="<?php echo($r['stu_id'])?>" readonly></td></tr>
            <tr><td>NAME:</td><td><input type="text" name="n" value="<?php echo($r['name'])?>" readonly></td></tr>
            <tr><td>ADDRESS:</td><td><textarea name="add"><?php echo($r['address'])?></textarea></td></tr>
            <tr><td>EMAIL ID:</td><td><input type="email" name="eml" value="<?php echo($r['email']) ?>"></td></tr>
            <tr><td>PHONE NUMBER:</td><td><input type="text" name="phn" value="<?php echo($r['phone']) ?>"></td></tr>
