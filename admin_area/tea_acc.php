...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		...
		<hr>
		<div class="col-12">
			<p class="lead"><font size="4"  color="black"><b>Teacher Salary Details:</b></font></p>
...
<table border=2 align="center">
                                        <tr><th>TEACHER ID</th>
                                            ...
                                            <?php $s=mysqli_query($con,"SELECT a.stu_id,t.name,a.amount,a.trans_id,a.trans_date FROM account as a inner join teacher as t on a.stu_id=t.tea_id where a.type='Teacher Salary'");
