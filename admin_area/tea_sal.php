...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		<div class="col-12">
			<h1 class="display-4">The Accouts Management System</h1>
		</div>
		<hr>
		<div class="col-12">
			<p class="lead"><font size="6"  color="black"><b>Pay Teacher Salary:</b></font></p>
            <!--<p class="lead">1. View the complete student list.</p>
            <p class="lead">2. Modify the student details.</p>-->
		</div>
	</div>
</div>
<center><font size="5"  color="black">Enter the Teacher ID and Pay their Salary: </font></center>
<section>
<table border='2' align="center"><form method="post" action="">
                               <tr><td>TEACHER ID : </td><td><input type="text" name="sid" required="" autocomplete="off"></td></tr>
                               <tr><td></td><td><button class="btn btn-primary btn-lg">Search</button></td></tr>
                                        </form></table>
                                        </section><br><br>
<?php
$sid=$_POST['sid'];
$s=mysqli_query($con,"select * from teacher where tea_id='$sid'");
...
<p><h2>SEARCH FOUND</h2></p></center>
          ...
          <img src="<?php echo($r['photo']) ?>" class="img-fluid" height="150px" width="200px"></center>
			<p><table align="center"><form method="post" action="pay_sal.php">
            <tr><td>USER ID:</td><td><input type="text" name="uid" value="<?php echo($r['tea_id'])?>" readonly></td></tr>
            <tr><td>NAME:</td><td><input type="text" name="n" value="<?php echo($r['name'])?>" readonly></td></tr>
            
            <tr><td>EMAIL ID:</td><td><input type="email" name="eml" value="<?php echo($r['email']) ?>" readonly></td></tr>
            <tr><td>SALARY:</td><td><input type="text" name="sal" autocomplete="off" required=""></td></tr>
            <tr><td></td><td><button class="btn btn-primary btn-lg">Pay Salary</button></td></tr>
            </form></table></p>
			<br>
...
if($_GET['ms']=='done'){
?><center>
<p><h3>Payment Succesful 😀</h3></p>
<p><h3>Transaction ID is <?php echo($_GET['tid']); ?></h3></p>
<p><h3>Salary paid is <?php echo($_GET['amt']); ?></h3></p>
<?php
}
else if($_GET['ms']=='not_done')
{
    ?><center>
<p><h3>Payment Unsuccesful 😌</h3></p>
<?php
}
?>
