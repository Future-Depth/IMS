...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		<div class="col-12">
			<h1 class="display-4">The Teacher Management System</h1>
		</div>
		<hr>
		<div class="col-12">
			<p class="lead"><font size="6"  color="black"><b>Modify Teacher Details:</b></font></p>
            <!--<p class="lead">1. View the complete student list.</p>
            <p class="lead">2. Modify the student details.</p>-->
		</div>
	</div>
</div>
<center><font size="5"  color="black">Search a Teacher Details by their Teacher ID</font></center>
<section>
...
<p><h2>SEARCH FOUND</h2></p></center>
          ...
          <img src="<?php echo($r['photo']) ?>" class="img-fluid" height="150px" width="200px"></center>
			<p><table align="center"><form method="post" action="tea_edit.php">
