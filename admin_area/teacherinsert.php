...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		...
		<hr>
		<div class="col-12">
			<p class="lead"><font size="6"  color="black"><b>Insert a Teacher Data:</b></font></p>
            <!--<p class="lead">1. View the complete student list.</p>
            <p class="lead">2. Modify the student details.</p>-->
		</div>
	</div>
</div>
<center><font size="5"  color="black">Fill all the details of the teacher</font></center>
<section>
<table border='2' align="center"><form method="post" action="teacher_registration.php" enctype="multipart/form-data">
                  ...
                  <tr><td>HIGHEST QUALIFICATION:</td><td><input type="text" name="hql" required="" autocomplete="off"></td></tr>
                  ...
                  <tr><td>UPLOAD PHOTO:</td><td><input type="file" name="pht" required="" autocomplete="off"></td></tr>
                               <tr><td></td><td><button class="btn btn-primary btn-lg">Insert Teacher</button></td></tr>
                                        </form></table>
                                        </section><br><br>
...
if($_GET['ms']=='done'){
?><center>
<p><h3>Inserted Succesfully</h3></p>
<table border=2 align="center">
<tr><td>TEACHER ID:</td><td><?php echo($_GET['id']); ?></td></tr></table>
<?php
}
else if($_GET['ms']=='not_done')
{
    ?><center>
<p><h3>Insertion Failed</h3></p>
<?php
}
else if($_GET['ms']=='present')
{
    ?><center>
<p><h3>Teacher ID already exists with same Email ID</h3></p>
<?php
}
?>
?>
