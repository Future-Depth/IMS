  ...
  <body class="size-1280 primary-color-red">
    ...
    <main role="main">    
      ...
      <section class="section background-dark">  
        <div class="line">
          <h2 class="text-white text-extra-strong text-size-80 text-m-size-40 margin-bottom-40">Your Course Details</h2>
        </div>
        <div class="line">
          <div class="margin">
            <div class="s-12 m-12 l-3">
              <div class="block">
                <div class="count-to">
                  <span class="timer h1 text-size-30 text-orange">Number of enrolled Courses</span>
                  <?php 
                  $sid=$_SESSION['btt']['stu_id'];
                  $sq="select * from studentcourse where stu_id='$sid'";
                  $ss=mysqli_query($con,$sq);
                  $val=mysqli_num_rows($ss);?>
                  <p class="h1 text-size-20 margin-top-10 text-white text-thin"><?php echo($val) ?></p> 
                </div>
              </div>
            </div>
            <div class="s-12 m-12 l-3">
              <div class="block">
                <div class="count-to">
                  <span class="timer h1 text-size-30 text-red">Enroll in a courses</span>
                  <p class="h1 text-size-20 margin-top-10 text-white text-thin"><a class="button text-white background-primary margin-bottom-60" href="enrollcourse.php">Enroll Now</a></p> 
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section background-image" style="background-image:url(img/parallax-04.jpg)">  
        <div class="line">
          <h2 class="text-white text-extra-strong text-size-80 text-m-size-40 margin-bottom-40"><span class="text-orange">Hurry up</span> Learn your favourite courses with best hand on projects.</h2>
          <p class="text-white text-size-20 margin-bottom-30">
            Choose your favourite courses and learn everyting about it and make yourself ready with a hand-on project.
          </p>
          <p class="text-white text-handwrite text-size-50 margin-bottom-20">Quickly Register Yourself.</p>
          <a class="button text-white background-orange" href="enrollcourse.php">Register for a Course</a>  
        </div>
      </section>
