	...
	<div class="row padding">
        ...
        <div class="line">
          <h2 class="text-extra-strong text-size-80 text-m-size-40 margin-bottom-40">Complete your Payment</h2>
			...
			<p><table><form method="post" action="pay.php">
            ...
            <tr><td>STUDENT ID:</td><td><input type="text" name="sid" autocomplete="off" required=""></td></tr>
            
            <tr><td></td><td><button class="button text-white background-primary margin-bottom-60">Pay Now</button></td></tr>
            </form></p>
			<br>
