...
<html lang="en-US">
  ...
  <body class="size-1280 primary-color-red">
    ...
    <main role="main">    
        ...
        <header class="section-head background-image" style="background-image:url(img/banner.png)">
          <div class="line">
            ...
            <div class="profileimg">
              <!-- Image --> 
              <center><img src="<?php echo $_SESSION['btt']['photo'] ?>" alt=""></center>
              <div class="line">
                <h2 class="text-extra-strong text-size-80 text-m-size-40 margin-bottom-40">Welcome <?php echo $_SESSION['btt']['name'] ?></h2>
              </div>
      ...
      <!-- Section 1 -->
      <?php
      if($_SESSION['btt']['profile']!=""){?>
      <section class="section background-white">
        <div class="line">
          <h2 class="text-extra-strong text-size-80 text-m-size-40 margin-bottom-40">Who Am I?</h2>
        </div>
        <div class="line">
          <div class="margin2x">
            <div class="m-12 l-6">
              <h3 class="text-strong"><?php echo $_SESSION['btt']['profile'] ?></h3>
            ...
            <!--<div class="m-12 l-6 margin-m-bottom-30 profileimg">
               
              <img src="<?php echo $_SESSION['btt']['photo'] ?>" alt="">
             </div> -->
            ...
            <div class="s-12 m-12 l-3">
              <div class="block">
                <div class="count-to">
                  ...
                  <p class="h1 text-size-20 margin-top-10 text-white text-thin"><?php echo $_SESSION['btt']['email'] ?></p> 
                </div>
              </div>
            </div>
            <div class="s-12 m-12 l-3">
              <div class="block">
                <div class="count-to">
                  ...
                  <p class="h1 text-size-20 margin-top-10 text-white text-thin"><?php echo $_SESSION['btt']['phone'] ?></p> 
                </div>
              </div>
            </div>
            <div class="s-12 m-12 l-3">
              <div class="block">
                <div class="count-to">
                  ...
                  <p class="h1 text-size-20 margin-top-10 text-white text-thin"><?php echo $_SESSION['btt']['address'] ?></p> 
                </div>
              </div>
            </div>
            <div class="s-12 m-12 l-3">
              <div class="block">
                <div class="count-to">
                  ...
                  <p class="h1 text-size-20 margin-top-10 text-white text-thin"><a class="button text-white background-primary margin-bottom-60" href="edit_stu.php">Edit</a></p> 
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section-top-bottom-padding">  
        <div class="line">
          <h2 class="text-extra-strong text-size-80 text-m-size-40 margin-bottom-40">My Enrolled Courses</h2>
        </div>
        ...
        <?php
        $i=1;
        $tid=$_SESSION['btt']['stu_id'];
        $sql="SELECT course.photo as cp,course.c_name as cn,studentcourse.status as ss from studentcourse 
        INNER JOIN course ON course.c_id = studentcourse.c_id WHERE studentcourse.stu_id='$tid'";
            ...
            <div class="image-with-text-overlay">
              <div class="image-text-overlay"> 
                <div class="image-text-overlay-content padding-2x">
                  ...
                  <h3 class="text-white text-size-30 text-strong"><?php echo($r['cn']) ?></h3>
                  <p class="text-white">Status : <?php echo($r['ss']) ?></p> 
                </div> 
              </div>  
              <!-- Photo -->
              <span class="courseimg">
              <img src="admin_area/<?php echo($r['cp']) ?>" ></span>
            </div>                                                                                                                                                                          
          </div>
          <?php
            $i=$i+1;   
